...
1. Explain what a token is used for.
    It is a credential used to access protected content. 
2. What steps can you take in your web apps to keep your data secure?
  Well the main thing we could use are tokens, certificates, cookies - Our app will check to see if its authenticated or logged in with a specific username/password than a Token will be issued. 
3. Describe how web servers work.  
  Allows anyone using any computer to access our webpage. Web servers store code for websites to be shared across the world. When we load the code to our webpages the sever would be "hosting" our web page. 
4. Which HTTP methods can be mapped to the CRUD acronym that we use when interfacing with APIs/Servers.
   .Put is the "U". Put will update data from API. 
   .Delete is the D. We can use Delete to delete data that is in the API. 
